...
func IntegratedPack(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int, bit int) error {
	switch (bit) {
	case 0:
	...
	case 32:
		if len(out) < outpos + 32 {
			return errors.New("encoding/IntegratedPack: len(out) < outpos + 32")
		}

		if len(in) < inpos + 32 {
			return errors.New("encoding/IntegratedPack: len(in) < inpos + 32")
		}

		integratedpack32(initoffset, in, inpos, out, outpos)

	default:
		return errors.New("encoding/IntegratedPack: Unsupported bit width")
	}

	return nil
}

func IntegratedUnpack(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int, bit int) error {
	switch (bit) {
	case 0:
...
func integratedunpack0(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	for i := outpos; i < outpos + 32; i++ {
		out[i] = initoffset
	}
}

func integratedpack0(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	// nothing
}

func integratedunpack32(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	copy(out[outpos:outpos + 32], in[inpos:inpos + 32])
}

func integratedpack32(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	copy(out[outpos:outpos + 32], in[inpos:inpos + 32])
}
...
func integratedpack2(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack3(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack4(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack5(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack6(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack7(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack8(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack9(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack10(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack11(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack12(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack13(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack14(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack15(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack16(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack17(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack18(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack19(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack20(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack21(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack22(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack23(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack24(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack25(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack26(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack27(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack28(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack29(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack30(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedpack31(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedunpack1(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[10 + outpos] = (((in[0 + inpos]>>10) & 1) ) + out[10 + outpos - 1];

	out[11 + outpos] = (((in[0 + inpos]>>11) & 1) ) + out[11 + outpos - 1];

	out[12 + outpos] = (((in[0 + inpos]>>12) & 1) ) + out[12 + outpos - 1];

	out[13 + outpos] = (((in[0 + inpos]>>13) & 1) ) + out[13 + outpos - 1];

	out[14 + outpos] = (((in[0 + inpos]>>14) & 1) ) + out[14 + outpos - 1];

	out[15 + outpos] = (((in[0 + inpos]>>15) & 1) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[0 + inpos]>>16) & 1) ) + out[16 + outpos - 1];

	out[17 + outpos] = (((in[0 + inpos]>>17) & 1) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[0 + inpos]>>18) & 1) ) + out[18 + outpos - 1];

	out[19 + outpos] = (((in[0 + inpos]>>19) & 1) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[0 + inpos]>>20) & 1) ) + out[20 + outpos - 1];

	out[21 + outpos] = (((in[0 + inpos]>>21) & 1) ) + out[21 + outpos - 1];

	out[22 + outpos] = (((in[0 + inpos]>>22) & 1) ) + out[22 + outpos - 1];

	out[23 + outpos] = (((in[0 + inpos]>>23) & 1) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[0 + inpos]>>24) & 1) ) + out[24 + outpos - 1];

	out[25 + outpos] = (((in[0 + inpos]>>25) & 1) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[0 + inpos]>>26) & 1) ) + out[26 + outpos - 1];

	out[27 + outpos] = (((in[0 + inpos]>>27) & 1) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[0 + inpos]>>28) & 1) ) + out[28 + outpos - 1];

	out[29 + outpos] = (((in[0 + inpos]>>29) & 1) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[0 + inpos]>>30) & 1) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[0 + inpos]>>31) ) + out[31 + outpos - 1];
}


func integratedunpack2(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[10 + outpos] = (((in[0 + inpos]>>20) & 3) ) + out[10 + outpos - 1];

	out[11 + outpos] = (((in[0 + inpos]>>22) & 3) ) + out[11 + outpos - 1];

	out[12 + outpos] = (((in[0 + inpos]>>24) & 3) ) + out[12 + outpos - 1];

	out[13 + outpos] = (((in[0 + inpos]>>26) & 3) ) + out[13 + outpos - 1];

	out[14 + outpos] = (((in[0 + inpos]>>28) & 3) ) + out[14 + outpos - 1];
	...
	out[21 + outpos] = (((in[1 + inpos]>>10) & 3) ) + out[21 + outpos - 1];

	out[22 + outpos] = (((in[1 + inpos]>>12) & 3) ) + out[22 + outpos - 1];

	out[23 + outpos] = (((in[1 + inpos]>>14) & 3) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[1 + inpos]>>16) & 3) ) + out[24 + outpos - 1];

	out[25 + outpos] = (((in[1 + inpos]>>18) & 3) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[1 + inpos]>>20) & 3) ) + out[26 + outpos - 1];

	out[27 + outpos] = (((in[1 + inpos]>>22) & 3) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[1 + inpos]>>24) & 3) ) + out[28 + outpos - 1];

	out[29 + outpos] = (((in[1 + inpos]>>26) & 3) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[1 + inpos]>>28) & 3) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[1 + inpos]>>30) ) + out[31 + outpos - 1];
}


func integratedunpack3(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[14 + outpos] = (((in[1 + inpos]>>10) & 7) ) + out[14 + outpos - 1];

	out[15 + outpos] = (((in[1 + inpos]>>13) & 7) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[1 + inpos]>>16) & 7) ) + out[16 + outpos - 1];

	out[17 + outpos] = (((in[1 + inpos]>>19) & 7) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[1 + inpos]>>22) & 7) ) + out[18 + outpos - 1];

	out[19 + outpos] = (((in[1 + inpos]>>25) & 7) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[1 + inpos]>>28) & 7) ) + out[20 + outpos - 1];
	...
	out[25 + outpos] = (((in[2 + inpos]>>11) & 7) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[2 + inpos]>>14) & 7) ) + out[26 + outpos - 1];

	out[27 + outpos] = (((in[2 + inpos]>>17) & 7) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[2 + inpos]>>20) & 7) ) + out[28 + outpos - 1];

	out[29 + outpos] = (((in[2 + inpos]>>23) & 7) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[2 + inpos]>>26) & 7) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[2 + inpos]>>29) ) + out[31 + outpos - 1];
}


func integratedunpack4(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[10 + outpos] = (((in[1 + inpos]>>8) & 15) ) + out[10 + outpos - 1];

	out[11 + outpos] = (((in[1 + inpos]>>12) & 15) ) + out[11 + outpos - 1];

	out[12 + outpos] = (((in[1 + inpos]>>16) & 15) ) + out[12 + outpos - 1];

	out[13 + outpos] = (((in[1 + inpos]>>20) & 15) ) + out[13 + outpos - 1];

	out[14 + outpos] = (((in[1 + inpos]>>24) & 15) ) + out[14 + outpos - 1];

	out[15 + outpos] = ((in[1 + inpos]>>28) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[2 + inpos]>>0) & 15) ) + out[16 + outpos - 1];

	out[17 + outpos] = (((in[2 + inpos]>>4) & 15) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[2 + inpos]>>8) & 15) ) + out[18 + outpos - 1];

	out[19 + outpos] = (((in[2 + inpos]>>12) & 15) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[2 + inpos]>>16) & 15) ) + out[20 + outpos - 1];

	out[21 + outpos] = (((in[2 + inpos]>>20) & 15) ) + out[21 + outpos - 1];

	out[22 + outpos] = (((in[2 + inpos]>>24) & 15) ) + out[22 + outpos - 1];

	out[23 + outpos] = ((in[2 + inpos]>>28) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[3 + inpos]>>0) & 15) ) + out[24 + outpos - 1];

	out[25 + outpos] = (((in[3 + inpos]>>4) & 15) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[3 + inpos]>>8) & 15) ) + out[26 + outpos - 1];

	out[27 + outpos] = (((in[3 + inpos]>>12) & 15) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[3 + inpos]>>16) & 15) ) + out[28 + outpos - 1];

	out[29 + outpos] = (((in[3 + inpos]>>20) & 15) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[3 + inpos]>>24) & 15) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[3 + inpos]>>28) ) + out[31 + outpos - 1];
}


func integratedunpack5(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[10 + outpos] = (((in[1 + inpos]>>18) & 31) ) + out[10 + outpos - 1];

	out[11 + outpos] = (((in[1 + inpos]>>23) & 31) ) + out[11 + outpos - 1];

	out[12 + outpos] = ((in[1 + inpos]>>28) |
			((in[2 + inpos] & 1)<<(5 - 1)) ) + out[12 + outpos - 1];

	out[13 + outpos] = (((in[2 + inpos]>>1) & 31) ) + out[13 + outpos - 1];

	out[14 + outpos] = (((in[2 + inpos]>>6) & 31) ) + out[14 + outpos - 1];

	out[15 + outpos] = (((in[2 + inpos]>>11) & 31) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[2 + inpos]>>16) & 31) ) + out[16 + outpos - 1];

	out[17 + outpos] = (((in[2 + inpos]>>21) & 31) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[2 + inpos]>>26) & 31) ) + out[18 + outpos - 1];

	out[19 + outpos] = ((in[2 + inpos]>>31) |
			((in[3 + inpos] & 15)<<(5 - 4)) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[3 + inpos]>>4) & 31) ) + out[20 + outpos - 1];

	out[21 + outpos] = (((in[3 + inpos]>>9) & 31) ) + out[21 + outpos - 1];

	out[22 + outpos] = (((in[3 + inpos]>>14) & 31) ) + out[22 + outpos - 1];

	out[23 + outpos] = (((in[3 + inpos]>>19) & 31) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[3 + inpos]>>24) & 31) ) + out[24 + outpos - 1];

	out[25 + outpos] = ((in[3 + inpos]>>29) |
			((in[4 + inpos] & 3)<<(5 - 2)) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[4 + inpos]>>2) & 31) ) + out[26 + outpos - 1];

	out[27 + outpos] = (((in[4 + inpos]>>7) & 31) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[4 + inpos]>>12) & 31) ) + out[28 + outpos - 1];

	out[29 + outpos] = (((in[4 + inpos]>>17) & 31) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[4 + inpos]>>22) & 31) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[4 + inpos]>>27) ) + out[31 + outpos - 1];
}


func integratedunpack6(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[11 + outpos] = (((in[2 + inpos]>>2) & 63) ) + out[11 + outpos - 1];

	out[12 + outpos] = (((in[2 + inpos]>>8) & 63) ) + out[12 + outpos - 1];

	out[13 + outpos] = (((in[2 + inpos]>>14) & 63) ) + out[13 + outpos - 1];

	out[14 + outpos] = (((in[2 + inpos]>>20) & 63) ) + out[14 + outpos - 1];

	out[15 + outpos] = ((in[2 + inpos]>>26) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[3 + inpos]>>0) & 63) ) + out[16 + outpos - 1];

	out[17 + outpos] = (((in[3 + inpos]>>6) & 63) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[3 + inpos]>>12) & 63) ) + out[18 + outpos - 1];

	out[19 + outpos] = (((in[3 + inpos]>>18) & 63) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[3 + inpos]>>24) & 63) ) + out[20 + outpos - 1];

	out[21 + outpos] = ((in[3 + inpos]>>30) |
			((in[4 + inpos] & 15)<<(6 - 4)) ) + out[21 + outpos - 1];

	out[22 + outpos] = (((in[4 + inpos]>>4) & 63) ) + out[22 + outpos - 1];

	out[23 + outpos] = (((in[4 + inpos]>>10) & 63) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[4 + inpos]>>16) & 63) ) + out[24 + outpos - 1];

	out[25 + outpos] = (((in[4 + inpos]>>22) & 63) ) + out[25 + outpos - 1];

	out[26 + outpos] = ((in[4 + inpos]>>28) |
			((in[5 + inpos] & 3)<<(6 - 2)) ) + out[26 + outpos - 1];

	out[27 + outpos] = (((in[5 + inpos]>>2) & 63) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[5 + inpos]>>8) & 63) ) + out[28 + outpos - 1];

	out[29 + outpos] = (((in[5 + inpos]>>14) & 63) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[5 + inpos]>>20) & 63) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[5 + inpos]>>26) ) + out[31 + outpos - 1];
}


func integratedunpack7(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {

	out[0 + outpos] = (((in[0 + inpos]>>0) & 127) ) + initoffset;

	out[1 + outpos] = (((in[0 + inpos]>>7) & 127) ) + out[1 + outpos - 1];

	out[2 + outpos] = (((in[0 + inpos]>>14) & 127) ) + out[2 + outpos - 1];

	out[3 + outpos] = (((in[0 + inpos]>>21) & 127) ) + out[3 + outpos - 1];
	...
	out[6 + outpos] = (((in[1 + inpos]>>10) & 127) ) + out[6 + outpos - 1];

	out[7 + outpos] = (((in[1 + inpos]>>17) & 127) ) + out[7 + outpos - 1];

	out[8 + outpos] = (((in[1 + inpos]>>24) & 127) ) + out[8 + outpos - 1];

	out[9 + outpos] = ((in[1 + inpos]>>31) |
			((in[2 + inpos] & 63)<<(7 - 6)) ) + out[9 + outpos - 1];

	out[10 + outpos] = (((in[2 + inpos]>>6) & 127) ) + out[10 + outpos - 1];

	out[11 + outpos] = (((in[2 + inpos]>>13) & 127) ) + out[11 + outpos - 1];

	out[12 + outpos] = (((in[2 + inpos]>>20) & 127) ) + out[12 + outpos - 1];

	out[13 + outpos] = ((in[2 + inpos]>>27) |
			((in[3 + inpos] & 3)<<(7 - 2)) ) + out[13 + outpos - 1];

	out[14 + outpos] = (((in[3 + inpos]>>2) & 127) ) + out[14 + outpos - 1];

	out[15 + outpos] = (((in[3 + inpos]>>9) & 127) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[3 + inpos]>>16) & 127) ) + out[16 + outpos - 1];

	out[17 + outpos] = (((in[3 + inpos]>>23) & 127) ) + out[17 + outpos - 1];

	out[18 + outpos] = ((in[3 + inpos]>>30) |
			((in[4 + inpos] & 31)<<(7 - 5)) ) + out[18 + outpos - 1];

	out[19 + outpos] = (((in[4 + inpos]>>5) & 127) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[4 + inpos]>>12) & 127) ) + out[20 + outpos - 1];

	out[21 + outpos] = (((in[4 + inpos]>>19) & 127) ) + out[21 + outpos - 1];

	out[22 + outpos] = ((in[4 + inpos]>>26) |
			((in[5 + inpos] & 1)<<(7 - 1)) ) + out[22 + outpos - 1];

	out[23 + outpos] = (((in[5 + inpos]>>1) & 127) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[5 + inpos]>>8) & 127) ) + out[24 + outpos - 1];

	out[25 + outpos] = (((in[5 + inpos]>>15) & 127) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[5 + inpos]>>22) & 127) ) + out[26 + outpos - 1];

	out[27 + outpos] = ((in[5 + inpos]>>29) |
			((in[6 + inpos] & 15)<<(7 - 4)) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[6 + inpos]>>4) & 127) ) + out[28 + outpos - 1];

	out[29 + outpos] = (((in[6 + inpos]>>11) & 127) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[6 + inpos]>>18) & 127) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[6 + inpos]>>25) ) + out[31 + outpos - 1];
}


func integratedunpack8(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {

	out[0 + outpos] = (((in[0 + inpos]>>0) & 255) ) + initoffset;

	out[1 + outpos] = (((in[0 + inpos]>>8) & 255) ) + out[1 + outpos - 1];

	out[2 + outpos] = (((in[0 + inpos]>>16) & 255) ) + out[2 + outpos - 1];
	...
	out[6 + outpos] = (((in[1 + inpos]>>16) & 255) ) + out[6 + outpos - 1];
	...
	out[10 + outpos] = (((in[2 + inpos]>>16) & 255) ) + out[10 + outpos - 1];

	out[11 + outpos] = ((in[2 + inpos]>>24) ) + out[11 + outpos - 1];

	out[12 + outpos] = (((in[3 + inpos]>>0) & 255) ) + out[12 + outpos - 1];

	out[13 + outpos] = (((in[3 + inpos]>>8) & 255) ) + out[13 + outpos - 1];

	out[14 + outpos] = (((in[3 + inpos]>>16) & 255) ) + out[14 + outpos - 1];

	out[15 + outpos] = ((in[3 + inpos]>>24) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[4 + inpos]>>0) & 255) ) + out[16 + outpos - 1];

	out[17 + outpos] = (((in[4 + inpos]>>8) & 255) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[4 + inpos]>>16) & 255) ) + out[18 + outpos - 1];

	out[19 + outpos] = ((in[4 + inpos]>>24) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[5 + inpos]>>0) & 255) ) + out[20 + outpos - 1];

	out[21 + outpos] = (((in[5 + inpos]>>8) & 255) ) + out[21 + outpos - 1];

	out[22 + outpos] = (((in[5 + inpos]>>16) & 255) ) + out[22 + outpos - 1];

	out[23 + outpos] = ((in[5 + inpos]>>24) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[6 + inpos]>>0) & 255) ) + out[24 + outpos - 1];

	out[25 + outpos] = (((in[6 + inpos]>>8) & 255) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[6 + inpos]>>16) & 255) ) + out[26 + outpos - 1];

	out[27 + outpos] = ((in[6 + inpos]>>24) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[7 + inpos]>>0) & 255) ) + out[28 + outpos - 1];

	out[29 + outpos] = (((in[7 + inpos]>>8) & 255) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[7 + inpos]>>16) & 255) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[7 + inpos]>>24) ) + out[31 + outpos - 1];
}


func integratedunpack9(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {

	out[0 + outpos] = (((in[0 + inpos]>>0) & 511) ) + initoffset;

	out[1 + outpos] = (((in[0 + inpos]>>9) & 511) ) + out[1 + outpos - 1];

	out[2 + outpos] = (((in[0 + inpos]>>18) & 511) ) + out[2 + outpos - 1];
	...
	out[5 + outpos] = (((in[1 + inpos]>>13) & 511) ) + out[5 + outpos - 1];

	out[6 + outpos] = (((in[1 + inpos]>>22) & 511) ) + out[6 + outpos - 1];
	...
	out[9 + outpos] = (((in[2 + inpos]>>17) & 511) ) + out[9 + outpos - 1];

	out[10 + outpos] = ((in[2 + inpos]>>26) |
			((in[3 + inpos] & 7)<<(9 - 3)) ) + out[10 + outpos - 1];

	out[11 + outpos] = (((in[3 + inpos]>>3) & 511) ) + out[11 + outpos - 1];

	out[12 + outpos] = (((in[3 + inpos]>>12) & 511) ) + out[12 + outpos - 1];

	out[13 + outpos] = (((in[3 + inpos]>>21) & 511) ) + out[13 + outpos - 1];

	out[14 + outpos] = ((in[3 + inpos]>>30) |
			((in[4 + inpos] & 127)<<(9 - 7)) ) + out[14 + outpos - 1];

	out[15 + outpos] = (((in[4 + inpos]>>7) & 511) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[4 + inpos]>>16) & 511) ) + out[16 + outpos - 1];

	out[17 + outpos] = ((in[4 + inpos]>>25) |
			((in[5 + inpos] & 3)<<(9 - 2)) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[5 + inpos]>>2) & 511) ) + out[18 + outpos - 1];

	out[19 + outpos] = (((in[5 + inpos]>>11) & 511) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[5 + inpos]>>20) & 511) ) + out[20 + outpos - 1];

	out[21 + outpos] = ((in[5 + inpos]>>29) |
			((in[6 + inpos] & 63)<<(9 - 6)) ) + out[21 + outpos - 1];

	out[22 + outpos] = (((in[6 + inpos]>>6) & 511) ) + out[22 + outpos - 1];

	out[23 + outpos] = (((in[6 + inpos]>>15) & 511) ) + out[23 + outpos - 1];

	out[24 + outpos] = ((in[6 + inpos]>>24) |
			((in[7 + inpos] & 1)<<(9 - 1)) ) + out[24 + outpos - 1];

	out[25 + outpos] = (((in[7 + inpos]>>1) & 511) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[7 + inpos]>>10) & 511) ) + out[26 + outpos - 1];

	out[27 + outpos] = (((in[7 + inpos]>>19) & 511) ) + out[27 + outpos - 1];

	out[28 + outpos] = ((in[7 + inpos]>>28) |
			((in[8 + inpos] & 31)<<(9 - 5)) ) + out[28 + outpos - 1];

	out[29 + outpos] = (((in[8 + inpos]>>5) & 511) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[8 + inpos]>>14) & 511) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[8 + inpos]>>23) ) + out[31 + outpos - 1];
}


func integratedunpack10(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {

	out[0 + outpos] = (((in[0 + inpos]>>0) & 1023) ) + initoffset;

	out[1 + outpos] = (((in[0 + inpos]>>10) & 1023) ) + out[1 + outpos - 1];

	out[2 + outpos] = (((in[0 + inpos]>>20) & 1023) ) + out[2 + outpos - 1];

	out[3 + outpos] = ((in[0 + inpos]>>30) |
			((in[1 + inpos] & 255)<<(10 - 8)) ) + out[3 + outpos - 1];

	out[4 + outpos] = (((in[1 + inpos]>>8) & 1023) ) + out[4 + outpos - 1];

	out[5 + outpos] = (((in[1 + inpos]>>18) & 1023) ) + out[5 + outpos - 1];

	out[6 + outpos] = ((in[1 + inpos]>>28) |
			((in[2 + inpos] & 63)<<(10 - 6)) ) + out[6 + outpos - 1];

	out[7 + outpos] = (((in[2 + inpos]>>6) & 1023) ) + out[7 + outpos - 1];

	out[8 + outpos] = (((in[2 + inpos]>>16) & 1023) ) + out[8 + outpos - 1];

	out[9 + outpos] = ((in[2 + inpos]>>26) |
			((in[3 + inpos] & 15)<<(10 - 4)) ) + out[9 + outpos - 1];

	out[10 + outpos] = (((in[3 + inpos]>>4) & 1023) ) + out[10 + outpos - 1];

	out[11 + outpos] = (((in[3 + inpos]>>14) & 1023) ) + out[11 + outpos - 1];

	out[12 + outpos] = ((in[3 + inpos]>>24) |
			((in[4 + inpos] & 3)<<(10 - 2)) ) + out[12 + outpos - 1];

	out[13 + outpos] = (((in[4 + inpos]>>2) & 1023) ) + out[13 + outpos - 1];

	out[14 + outpos] = (((in[4 + inpos]>>12) & 1023) ) + out[14 + outpos - 1];

	out[15 + outpos] = ((in[4 + inpos]>>22) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[5 + inpos]>>0) & 1023) ) + out[16 + outpos - 1];

	out[17 + outpos] = (((in[5 + inpos]>>10) & 1023) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[5 + inpos]>>20) & 1023) ) + out[18 + outpos - 1];

	out[19 + outpos] = ((in[5 + inpos]>>30) |
			((in[6 + inpos] & 255)<<(10 - 8)) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[6 + inpos]>>8) & 1023) ) + out[20 + outpos - 1];

	out[21 + outpos] = (((in[6 + inpos]>>18) & 1023) ) + out[21 + outpos - 1];

	out[22 + outpos] = ((in[6 + inpos]>>28) |
			((in[7 + inpos] & 63)<<(10 - 6)) ) + out[22 + outpos - 1];

	out[23 + outpos] = (((in[7 + inpos]>>6) & 1023) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[7 + inpos]>>16) & 1023) ) + out[24 + outpos - 1];

	out[25 + outpos] = ((in[7 + inpos]>>26) |
			((in[8 + inpos] & 15)<<(10 - 4)) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[8 + inpos]>>4) & 1023) ) + out[26 + outpos - 1];

	out[27 + outpos] = (((in[8 + inpos]>>14) & 1023) ) + out[27 + outpos - 1];

	out[28 + outpos] = ((in[8 + inpos]>>24) |
			((in[9 + inpos] & 3)<<(10 - 2)) ) + out[28 + outpos - 1];

	out[29 + outpos] = (((in[9 + inpos]>>2) & 1023) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[9 + inpos]>>12) & 1023) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[9 + inpos]>>22) ) + out[31 + outpos - 1];
}


func integratedunpack11(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {

	out[0 + outpos] = (((in[0 + inpos]>>0) & 2047) ) + initoffset;

	out[1 + outpos] = (((in[0 + inpos]>>11) & 2047) ) + out[1 + outpos - 1];

	out[2 + outpos] = ((in[0 + inpos]>>22) |
			((in[1 + inpos] & 1)<<(11 - 1)) ) + out[2 + outpos - 1];

	out[3 + outpos] = (((in[1 + inpos]>>1) & 2047) ) + out[3 + outpos - 1];

	out[4 + outpos] = (((in[1 + inpos]>>12) & 2047) ) + out[4 + outpos - 1];

	out[5 + outpos] = ((in[1 + inpos]>>23) |
			((in[2 + inpos] & 3)<<(11 - 2)) ) + out[5 + outpos - 1];

	out[6 + outpos] = (((in[2 + inpos]>>2) & 2047) ) + out[6 + outpos - 1];

	out[7 + outpos] = (((in[2 + inpos]>>13) & 2047) ) + out[7 + outpos - 1];

	out[8 + outpos] = ((in[2 + inpos]>>24) |
			((in[3 + inpos] & 7)<<(11 - 3)) ) + out[8 + outpos - 1];

	out[9 + outpos] = (((in[3 + inpos]>>3) & 2047) ) + out[9 + outpos - 1];

	out[10 + outpos] = (((in[3 + inpos]>>14) & 2047) ) + out[10 + outpos - 1];

	out[11 + outpos] = ((in[3 + inpos]>>25) |
			((in[4 + inpos] & 15)<<(11 - 4)) ) + out[11 + outpos - 1];

	out[12 + outpos] = (((in[4 + inpos]>>4) & 2047) ) + out[12 + outpos - 1];

	out[13 + outpos] = (((in[4 + inpos]>>15) & 2047) ) + out[13 + outpos - 1];

	out[14 + outpos] = ((in[4 + inpos]>>26) |
			((in[5 + inpos] & 31)<<(11 - 5)) ) + out[14 + outpos - 1];

	out[15 + outpos] = (((in[5 + inpos]>>5) & 2047) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[5 + inpos]>>16) & 2047) ) + out[16 + outpos - 1];

	out[17 + outpos] = ((in[5 + inpos]>>27) |
			((in[6 + inpos] & 63)<<(11 - 6)) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[6 + inpos]>>6) & 2047) ) + out[18 + outpos - 1];

	out[19 + outpos] = (((in[6 + inpos]>>17) & 2047) ) + out[19 + outpos - 1];

	out[20 + outpos] = ((in[6 + inpos]>>28) |
			((in[7 + inpos] & 127)<<(11 - 7)) ) + out[20 + outpos - 1];

	out[21 + outpos] = (((in[7 + inpos]>>7) & 2047) ) + out[21 + outpos - 1];

	out[22 + outpos] = (((in[7 + inpos]>>18) & 2047) ) + out[22 + outpos - 1];

	out[23 + outpos] = ((in[7 + inpos]>>29) |
			((in[8 + inpos] & 255)<<(11 - 8)) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[8 + inpos]>>8) & 2047) ) + out[24 + outpos - 1];

	out[25 + outpos] = (((in[8 + inpos]>>19) & 2047) ) + out[25 + outpos - 1];

	out[26 + outpos] = ((in[8 + inpos]>>30) |
			((in[9 + inpos] & 511)<<(11 - 9)) ) + out[26 + outpos - 1];

	out[27 + outpos] = (((in[9 + inpos]>>9) & 2047) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[9 + inpos]>>20) & 2047) ) + out[28 + outpos - 1];

	out[29 + outpos] = ((in[9 + inpos]>>31) |
			((in[10 + inpos] & 1023)<<(11 - 10)) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[10 + inpos]>>10) & 2047) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[10 + inpos]>>21) ) + out[31 + outpos - 1];
}


func integratedunpack12(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {

	out[0 + outpos] = (((in[0 + inpos]>>0) & 4095) ) + initoffset;

	out[1 + outpos] = (((in[0 + inpos]>>12) & 4095) ) + out[1 + outpos - 1];

	out[2 + outpos] = ((in[0 + inpos]>>24) |
			((in[1 + inpos] & 15)<<(12 - 4)) ) + out[2 + outpos - 1];

	out[3 + outpos] = (((in[1 + inpos]>>4) & 4095) ) + out[3 + outpos - 1];

	out[4 + outpos] = (((in[1 + inpos]>>16) & 4095) ) + out[4 + outpos - 1];

	out[5 + outpos] = ((in[1 + inpos]>>28) |
			((in[2 + inpos] & 255)<<(12 - 8)) ) + out[5 + outpos - 1];

	out[6 + outpos] = (((in[2 + inpos]>>8) & 4095) ) + out[6 + outpos - 1];

	out[7 + outpos] = ((in[2 + inpos]>>20) ) + out[7 + outpos - 1];

	out[8 + outpos] = (((in[3 + inpos]>>0) & 4095) ) + out[8 + outpos - 1];

	out[9 + outpos] = (((in[3 + inpos]>>12) & 4095) ) + out[9 + outpos - 1];

	out[10 + outpos] = ((in[3 + inpos]>>24) |
			((in[4 + inpos] & 15)<<(12 - 4)) ) + out[10 + outpos - 1];

	out[11 + outpos] = (((in[4 + inpos]>>4) & 4095) ) + out[11 + outpos - 1];

	out[12 + outpos] = (((in[4 + inpos]>>16) & 4095) ) + out[12 + outpos - 1];

	out[13 + outpos] = ((in[4 + inpos]>>28) |
			((in[5 + inpos] & 255)<<(12 - 8)) ) + out[13 + outpos - 1];

	out[14 + outpos] = (((in[5 + inpos]>>8) & 4095) ) + out[14 + outpos - 1];

	out[15 + outpos] = ((in[5 + inpos]>>20) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[6 + inpos]>>0) & 4095) ) + out[16 + outpos - 1];

	out[17 + outpos] = (((in[6 + inpos]>>12) & 4095) ) + out[17 + outpos - 1];

	out[18 + outpos] = ((in[6 + inpos]>>24) |
			((in[7 + inpos] & 15)<<(12 - 4)) ) + out[18 + outpos - 1];

	out[19 + outpos] = (((in[7 + inpos]>>4) & 4095) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[7 + inpos]>>16) & 4095) ) + out[20 + outpos - 1];

	out[21 + outpos] = ((in[7 + inpos]>>28) |
			((in[8 + inpos] & 255)<<(12 - 8)) ) + out[21 + outpos - 1];

	out[22 + outpos] = (((in[8 + inpos]>>8) & 4095) ) + out[22 + outpos - 1];

	out[23 + outpos] = ((in[8 + inpos]>>20) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[9 + inpos]>>0) & 4095) ) + out[24 + outpos - 1];

	out[25 + outpos] = (((in[9 + inpos]>>12) & 4095) ) + out[25 + outpos - 1];

	out[26 + outpos] = ((in[9 + inpos]>>24) |
			((in[10 + inpos] & 15)<<(12 - 4)) ) + out[26 + outpos - 1];

	out[27 + outpos] = (((in[10 + inpos]>>4) & 4095) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[10 + inpos]>>16) & 4095) ) + out[28 + outpos - 1];

	out[29 + outpos] = ((in[10 + inpos]>>28) |
			((in[11 + inpos] & 255)<<(12 - 8)) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[11 + inpos]>>8) & 4095) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[11 + inpos]>>20) ) + out[31 + outpos - 1];
}


func integratedunpack13(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {

	out[0 + outpos] = (((in[0 + inpos]>>0) & 8191) ) + initoffset;

	out[1 + outpos] = (((in[0 + inpos]>>13) & 8191) ) + out[1 + outpos - 1];

	out[2 + outpos] = ((in[0 + inpos]>>26) |
			((in[1 + inpos] & 127)<<(13 - 7)) ) + out[2 + outpos - 1];

	out[3 + outpos] = (((in[1 + inpos]>>7) & 8191) ) + out[3 + outpos - 1];

	out[4 + outpos] = ((in[1 + inpos]>>20) |
			((in[2 + inpos] & 1)<<(13 - 1)) ) + out[4 + outpos - 1];

	out[5 + outpos] = (((in[2 + inpos]>>1) & 8191) ) + out[5 + outpos - 1];

	out[6 + outpos] = (((in[2 + inpos]>>14) & 8191) ) + out[6 + outpos - 1];

	out[7 + outpos] = ((in[2 + inpos]>>27) |
			((in[3 + inpos] & 255)<<(13 - 8)) ) + out[7 + outpos - 1];

	out[8 + outpos] = (((in[3 + inpos]>>8) & 8191) ) + out[8 + outpos - 1];

	out[9 + outpos] = ((in[3 + inpos]>>21) |
			((in[4 + inpos] & 3)<<(13 - 2)) ) + out[9 + outpos - 1];

	out[10 + outpos] = (((in[4 + inpos]>>2) & 8191) ) + out[10 + outpos - 1];

	out[11 + outpos] = (((in[4 + inpos]>>15) & 8191) ) + out[11 + outpos - 1];

	out[12 + outpos] = ((in[4 + inpos]>>28) |
			((in[5 + inpos] & 511)<<(13 - 9)) ) + out[12 + outpos - 1];

	out[13 + outpos] = (((in[5 + inpos]>>9) & 8191) ) + out[13 + outpos - 1];

	out[14 + outpos] = ((in[5 + inpos]>>22) |
			((in[6 + inpos] & 7)<<(13 - 3)) ) + out[14 + outpos - 1];

	out[15 + outpos] = (((in[6 + inpos]>>3) & 8191) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[6 + inpos]>>16) & 8191) ) + out[16 + outpos - 1];

	out[17 + outpos] = ((in[6 + inpos]>>29) |
			((in[7 + inpos] & 1023)<<(13 - 10)) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[7 + inpos]>>10) & 8191) ) + out[18 + outpos - 1];

	out[19 + outpos] = ((in[7 + inpos]>>23) |
			((in[8 + inpos] & 15)<<(13 - 4)) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[8 + inpos]>>4) & 8191) ) + out[20 + outpos - 1];

	out[21 + outpos] = (((in[8 + inpos]>>17) & 8191) ) + out[21 + outpos - 1];

	out[22 + outpos] = ((in[8 + inpos]>>30) |
			((in[9 + inpos] & 2047)<<(13 - 11)) ) + out[22 + outpos - 1];

	out[23 + outpos] = (((in[9 + inpos]>>11) & 8191) ) + out[23 + outpos - 1];

	out[24 + outpos] = ((in[9 + inpos]>>24) |
			((in[10 + inpos] & 31)<<(13 - 5)) ) + out[24 + outpos - 1];

	out[25 + outpos] = (((in[10 + inpos]>>5) & 8191) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[10 + inpos]>>18) & 8191) ) + out[26 + outpos - 1];

	out[27 + outpos] = ((in[10 + inpos]>>31) |
			((in[11 + inpos] & 4095)<<(13 - 12)) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[11 + inpos]>>12) & 8191) ) + out[28 + outpos - 1];

	out[29 + outpos] = ((in[11 + inpos]>>25) |
			((in[12 + inpos] & 63)<<(13 - 6)) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[12 + inpos]>>6) & 8191) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[12 + inpos]>>19) ) + out[31 + outpos - 1];
}


func integratedunpack14(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {

	out[0 + outpos] = (((in[0 + inpos]>>0) & 16383) ) + initoffset;

	out[1 + outpos] = (((in[0 + inpos]>>14) & 16383) ) + out[1 + outpos - 1];

	out[2 + outpos] = ((in[0 + inpos]>>28) |
			((in[1 + inpos] & 1023)<<(14 - 10)) ) + out[2 + outpos - 1];

	out[3 + outpos] = (((in[1 + inpos]>>10) & 16383) ) + out[3 + outpos - 1];

	out[4 + outpos] = ((in[1 + inpos]>>24) |
			((in[2 + inpos] & 63)<<(14 - 6)) ) + out[4 + outpos - 1];

	out[5 + outpos] = (((in[2 + inpos]>>6) & 16383) ) + out[5 + outpos - 1];

	out[6 + outpos] = ((in[2 + inpos]>>20) |
			((in[3 + inpos] & 3)<<(14 - 2)) ) + out[6 + outpos - 1];

	out[7 + outpos] = (((in[3 + inpos]>>2) & 16383) ) + out[7 + outpos - 1];

	out[8 + outpos] = (((in[3 + inpos]>>16) & 16383) ) + out[8 + outpos - 1];

	out[9 + outpos] = ((in[3 + inpos]>>30) |
			((in[4 + inpos] & 4095)<<(14 - 12)) ) + out[9 + outpos - 1];

	out[10 + outpos] = (((in[4 + inpos]>>12) & 16383) ) + out[10 + outpos - 1];

	out[11 + outpos] = ((in[4 + inpos]>>26) |
			((in[5 + inpos] & 255)<<(14 - 8)) ) + out[11 + outpos - 1];

	out[12 + outpos] = (((in[5 + inpos]>>8) & 16383) ) + out[12 + outpos - 1];

	out[13 + outpos] = ((in[5 + inpos]>>22) |
			((in[6 + inpos] & 15)<<(14 - 4)) ) + out[13 + outpos - 1];

	out[14 + outpos] = (((in[6 + inpos]>>4) & 16383) ) + out[14 + outpos - 1];

	out[15 + outpos] = ((in[6 + inpos]>>18) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[7 + inpos]>>0) & 16383) ) + out[16 + outpos - 1];

	out[17 + outpos] = (((in[7 + inpos]>>14) & 16383) ) + out[17 + outpos - 1];

	out[18 + outpos] = ((in[7 + inpos]>>28) |
			((in[8 + inpos] & 1023)<<(14 - 10)) ) + out[18 + outpos - 1];

	out[19 + outpos] = (((in[8 + inpos]>>10) & 16383) ) + out[19 + outpos - 1];

	out[20 + outpos] = ((in[8 + inpos]>>24) |
			((in[9 + inpos] & 63)<<(14 - 6)) ) + out[20 + outpos - 1];

	out[21 + outpos] = (((in[9 + inpos]>>6) & 16383) ) + out[21 + outpos - 1];

	out[22 + outpos] = ((in[9 + inpos]>>20) |
			((in[10 + inpos] & 3)<<(14 - 2)) ) + out[22 + outpos - 1];

	out[23 + outpos] = (((in[10 + inpos]>>2) & 16383) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[10 + inpos]>>16) & 16383) ) + out[24 + outpos - 1];

	out[25 + outpos] = ((in[10 + inpos]>>30) |
			((in[11 + inpos] & 4095)<<(14 - 12)) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[11 + inpos]>>12) & 16383) ) + out[26 + outpos - 1];

	out[27 + outpos] = ((in[11 + inpos]>>26) |
			((in[12 + inpos] & 255)<<(14 - 8)) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[12 + inpos]>>8) & 16383) ) + out[28 + outpos - 1];

	out[29 + outpos] = ((in[12 + inpos]>>22) |
			((in[13 + inpos] & 15)<<(14 - 4)) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[13 + inpos]>>4) & 16383) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[13 + inpos]>>18) ) + out[31 + outpos - 1];
}


func integratedunpack15(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {

	out[0 + outpos] = (((in[0 + inpos]>>0) & 32767) ) + initoffset;

	out[1 + outpos] = (((in[0 + inpos]>>15) & 32767) ) + out[1 + outpos - 1];

	out[2 + outpos] = ((in[0 + inpos]>>30) |
			((in[1 + inpos] & 8191)<<(15 - 13)) ) + out[2 + outpos - 1];

	out[3 + outpos] = (((in[1 + inpos]>>13) & 32767) ) + out[3 + outpos - 1];

	out[4 + outpos] = ((in[1 + inpos]>>28) |
			((in[2 + inpos] & 2047)<<(15 - 11)) ) + out[4 + outpos - 1];

	out[5 + outpos] = (((in[2 + inpos]>>11) & 32767) ) + out[5 + outpos - 1];

	out[6 + outpos] = ((in[2 + inpos]>>26) |
			((in[3 + inpos] & 511)<<(15 - 9)) ) + out[6 + outpos - 1];

	out[7 + outpos] = (((in[3 + inpos]>>9) & 32767) ) + out[7 + outpos - 1];

	out[8 + outpos] = ((in[3 + inpos]>>24) |
			((in[4 + inpos] & 127)<<(15 - 7)) ) + out[8 + outpos - 1];

	out[9 + outpos] = (((in[4 + inpos]>>7) & 32767) ) + out[9 + outpos - 1];

	out[10 + outpos] = ((in[4 + inpos]>>22) |
			((in[5 + inpos] & 31)<<(15 - 5)) ) + out[10 + outpos - 1];

	out[11 + outpos] = (((in[5 + inpos]>>5) & 32767) ) + out[11 + outpos - 1];

	out[12 + outpos] = ((in[5 + inpos]>>20) |
			((in[6 + inpos] & 7)<<(15 - 3)) ) + out[12 + outpos - 1];

	out[13 + outpos] = (((in[6 + inpos]>>3) & 32767) ) + out[13 + outpos - 1];

	out[14 + outpos] = ((in[6 + inpos]>>18) |
			((in[7 + inpos] & 1)<<(15 - 1)) ) + out[14 + outpos - 1];

	out[15 + outpos] = (((in[7 + inpos]>>1) & 32767) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[7 + inpos]>>16) & 32767) ) + out[16 + outpos - 1];

	out[17 + outpos] = ((in[7 + inpos]>>31) |
			((in[8 + inpos] & 16383)<<(15 - 14)) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[8 + inpos]>>14) & 32767) ) + out[18 + outpos - 1];

	out[19 + outpos] = ((in[8 + inpos]>>29) |
			((in[9 + inpos] & 4095)<<(15 - 12)) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[9 + inpos]>>12) & 32767) ) + out[20 + outpos - 1];

	out[21 + outpos] = ((in[9 + inpos]>>27) |
			((in[10 + inpos] & 1023)<<(15 - 10)) ) + out[21 + outpos - 1];

	out[22 + outpos] = (((in[10 + inpos]>>10) & 32767) ) + out[22 + outpos - 1];

	out[23 + outpos] = ((in[10 + inpos]>>25) |
			((in[11 + inpos] & 255)<<(15 - 8)) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[11 + inpos]>>8) & 32767) ) + out[24 + outpos - 1];

	out[25 + outpos] = ((in[11 + inpos]>>23) |
			((in[12 + inpos] & 63)<<(15 - 6)) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[12 + inpos]>>6) & 32767) ) + out[26 + outpos - 1];

	out[27 + outpos] = ((in[12 + inpos]>>21) |
			((in[13 + inpos] & 15)<<(15 - 4)) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[13 + inpos]>>4) & 32767) ) + out[28 + outpos - 1];

	out[29 + outpos] = ((in[13 + inpos]>>19) |
			((in[14 + inpos] & 3)<<(15 - 2)) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[14 + inpos]>>2) & 32767) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[14 + inpos]>>17) ) + out[31 + outpos - 1];
}


func integratedunpack16(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {

	out[0 + outpos] = (((in[0 + inpos]>>0) & 65535) ) + initoffset;

	out[1 + outpos] = ((in[0 + inpos]>>16) ) + out[1 + outpos - 1];

	out[2 + outpos] = (((in[1 + inpos]>>0) & 65535) ) + out[2 + outpos - 1];

	out[3 + outpos] = ((in[1 + inpos]>>16) ) + out[3 + outpos - 1];

	out[4 + outpos] = (((in[2 + inpos]>>0) & 65535) ) + out[4 + outpos - 1];

	out[5 + outpos] = ((in[2 + inpos]>>16) ) + out[5 + outpos - 1];

	out[6 + outpos] = (((in[3 + inpos]>>0) & 65535) ) + out[6 + outpos - 1];

	out[7 + outpos] = ((in[3 + inpos]>>16) ) + out[7 + outpos - 1];

	out[8 + outpos] = (((in[4 + inpos]>>0) & 65535) ) + out[8 + outpos - 1];

	out[9 + outpos] = ((in[4 + inpos]>>16) ) + out[9 + outpos - 1];

	out[10 + outpos] = (((in[5 + inpos]>>0) & 65535) ) + out[10 + outpos - 1];

	out[11 + outpos] = ((in[5 + inpos]>>16) ) + out[11 + outpos - 1];

	out[12 + outpos] = (((in[6 + inpos]>>0) & 65535) ) + out[12 + outpos - 1];

	out[13 + outpos] = ((in[6 + inpos]>>16) ) + out[13 + outpos - 1];

	out[14 + outpos] = (((in[7 + inpos]>>0) & 65535) ) + out[14 + outpos - 1];

	out[15 + outpos] = ((in[7 + inpos]>>16) ) + out[15 + outpos - 1];

	out[16 + outpos] = (((in[8 + inpos]>>0) & 65535) ) + out[16 + outpos - 1];

	out[17 + outpos] = ((in[8 + inpos]>>16) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[9 + inpos]>>0) & 65535) ) + out[18 + outpos - 1];

	out[19 + outpos] = ((in[9 + inpos]>>16) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[10 + inpos]>>0) & 65535) ) + out[20 + outpos - 1];

	out[21 + outpos] = ((in[10 + inpos]>>16) ) + out[21 + outpos - 1];

	out[22 + outpos] = (((in[11 + inpos]>>0) & 65535) ) + out[22 + outpos - 1];

	out[23 + outpos] = ((in[11 + inpos]>>16) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[12 + inpos]>>0) & 65535) ) + out[24 + outpos - 1];

	out[25 + outpos] = ((in[12 + inpos]>>16) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[13 + inpos]>>0) & 65535) ) + out[26 + outpos - 1];

	out[27 + outpos] = ((in[13 + inpos]>>16) ) + out[27 + outpos - 1];

	out[28 + outpos] = (((in[14 + inpos]>>0) & 65535) ) + out[28 + outpos - 1];

	out[29 + outpos] = ((in[14 + inpos]>>16) ) + out[29 + outpos - 1];

	out[30 + outpos] = (((in[15 + inpos]>>0) & 65535) ) + out[30 + outpos - 1];

	out[31 + outpos] = ((in[15 + inpos]>>16) ) + out[31 + outpos - 1];
}


func integratedunpack17(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
...
func integratedunpack18(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[2 + outpos] = (((in[1 + inpos]>>4) & 262143) ) + out[2 + outpos - 1];

	out[3 + outpos] = ((in[1 + inpos]>>22) |
			((in[2 + inpos] & 255)<<(18 - 8)) ) + out[3 + outpos - 1];

	out[4 + outpos] = (((in[2 + inpos]>>8) & 262143) ) + out[4 + outpos - 1];

	out[5 + outpos] = ((in[2 + inpos]>>26) |
			((in[3 + inpos] & 4095)<<(18 - 12)) ) + out[5 + outpos - 1];

	out[6 + outpos] = (((in[3 + inpos]>>12) & 262143) ) + out[6 + outpos - 1];
	...
	out[9 + outpos] = (((in[5 + inpos]>>2) & 262143) ) + out[9 + outpos - 1];

	out[10 + outpos] = ((in[5 + inpos]>>20) |
			((in[6 + inpos] & 63)<<(18 - 6)) ) + out[10 + outpos - 1];

	out[11 + outpos] = (((in[6 + inpos]>>6) & 262143) ) + out[11 + outpos - 1];

	out[12 + outpos] = ((in[6 + inpos]>>24) |
			((in[7 + inpos] & 1023)<<(18 - 10)) ) + out[12 + outpos - 1];

	out[13 + outpos] = (((in[7 + inpos]>>10) & 262143) ) + out[13 + outpos - 1];
	...
	out[16 + outpos] = (((in[9 + inpos]>>0) & 262143) ) + out[16 + outpos - 1];

	out[17 + outpos] = ((in[9 + inpos]>>18) |
			((in[10 + inpos] & 15)<<(18 - 4)) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[10 + inpos]>>4) & 262143) ) + out[18 + outpos - 1];

	out[19 + outpos] = ((in[10 + inpos]>>22) |
			((in[11 + inpos] & 255)<<(18 - 8)) ) + out[19 + outpos - 1];

	out[20 + outpos] = (((in[11 + inpos]>>8) & 262143) ) + out[20 + outpos - 1];

	out[21 + outpos] = ((in[11 + inpos]>>26) |
			((in[12 + inpos] & 4095)<<(18 - 12)) ) + out[21 + outpos - 1];

	out[22 + outpos] = (((in[12 + inpos]>>12) & 262143) ) + out[22 + outpos - 1];
	...
	out[25 + outpos] = (((in[14 + inpos]>>2) & 262143) ) + out[25 + outpos - 1];

	out[26 + outpos] = ((in[14 + inpos]>>20) |
			((in[15 + inpos] & 63)<<(18 - 6)) ) + out[26 + outpos - 1];

	out[27 + outpos] = (((in[15 + inpos]>>6) & 262143) ) + out[27 + outpos - 1];

	out[28 + outpos] = ((in[15 + inpos]>>24) |
			((in[16 + inpos] & 1023)<<(18 - 10)) ) + out[28 + outpos - 1];

	out[29 + outpos] = (((in[16 + inpos]>>10) & 262143) ) + out[29 + outpos - 1];
...
func integratedunpack19(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[2 + outpos] = (((in[1 + inpos]>>6) & 524287) ) + out[2 + outpos - 1];

	out[3 + outpos] = ((in[1 + inpos]>>25) |
			((in[2 + inpos] & 4095)<<(19 - 12)) ) + out[3 + outpos - 1];

	out[4 + outpos] = (((in[2 + inpos]>>12) & 524287) ) + out[4 + outpos - 1];
	...
	out[7 + outpos] = (((in[4 + inpos]>>5) & 524287) ) + out[7 + outpos - 1];

	out[8 + outpos] = ((in[4 + inpos]>>24) |
			((in[5 + inpos] & 2047)<<(19 - 11)) ) + out[8 + outpos - 1];

	out[9 + outpos] = (((in[5 + inpos]>>11) & 524287) ) + out[9 + outpos - 1];
	...
	out[12 + outpos] = (((in[7 + inpos]>>4) & 524287) ) + out[12 + outpos - 1];

	out[13 + outpos] = ((in[7 + inpos]>>23) |
			((in[8 + inpos] & 1023)<<(19 - 10)) ) + out[13 + outpos - 1];

	out[14 + outpos] = (((in[8 + inpos]>>10) & 524287) ) + out[14 + outpos - 1];
	...
	out[17 + outpos] = (((in[10 + inpos]>>3) & 524287) ) + out[17 + outpos - 1];

	out[18 + outpos] = ((in[10 + inpos]>>22) |
			((in[11 + inpos] & 511)<<(19 - 9)) ) + out[18 + outpos - 1];

	out[19 + outpos] = (((in[11 + inpos]>>9) & 524287) ) + out[19 + outpos - 1];
	...
	out[22 + outpos] = (((in[13 + inpos]>>2) & 524287) ) + out[22 + outpos - 1];

	out[23 + outpos] = ((in[13 + inpos]>>21) |
			((in[14 + inpos] & 255)<<(19 - 8)) ) + out[23 + outpos - 1];

	out[24 + outpos] = (((in[14 + inpos]>>8) & 524287) ) + out[24 + outpos - 1];
	...
	out[27 + outpos] = (((in[16 + inpos]>>1) & 524287) ) + out[27 + outpos - 1];

	out[28 + outpos] = ((in[16 + inpos]>>20) |
			((in[17 + inpos] & 127)<<(19 - 7)) ) + out[28 + outpos - 1];

	out[29 + outpos] = (((in[17 + inpos]>>7) & 524287) ) + out[29 + outpos - 1];
...
func integratedunpack20(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[2 + outpos] = (((in[1 + inpos]>>8) & 1048575) ) + out[2 + outpos - 1];
	...
	out[5 + outpos] = (((in[3 + inpos]>>4) & 1048575) ) + out[5 + outpos - 1];
	...
	out[8 + outpos] = (((in[5 + inpos]>>0) & 1048575) ) + out[8 + outpos - 1];

	out[9 + outpos] = ((in[5 + inpos]>>20) |
			((in[6 + inpos] & 255)<<(20 - 8)) ) + out[9 + outpos - 1];

	out[10 + outpos] = (((in[6 + inpos]>>8) & 1048575) ) + out[10 + outpos - 1];
	...
	out[13 + outpos] = (((in[8 + inpos]>>4) & 1048575) ) + out[13 + outpos - 1];
	...
	out[16 + outpos] = (((in[10 + inpos]>>0) & 1048575) ) + out[16 + outpos - 1];

	out[17 + outpos] = ((in[10 + inpos]>>20) |
			((in[11 + inpos] & 255)<<(20 - 8)) ) + out[17 + outpos - 1];

	out[18 + outpos] = (((in[11 + inpos]>>8) & 1048575) ) + out[18 + outpos - 1];
	...
	out[21 + outpos] = (((in[13 + inpos]>>4) & 1048575) ) + out[21 + outpos - 1];
	...
	out[24 + outpos] = (((in[15 + inpos]>>0) & 1048575) ) + out[24 + outpos - 1];

	out[25 + outpos] = ((in[15 + inpos]>>20) |
			((in[16 + inpos] & 255)<<(20 - 8)) ) + out[25 + outpos - 1];

	out[26 + outpos] = (((in[16 + inpos]>>8) & 1048575) ) + out[26 + outpos - 1];
	...
	out[29 + outpos] = (((in[18 + inpos]>>4) & 1048575) ) + out[29 + outpos - 1];
...
func integratedunpack21(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[2 + outpos] = (((in[1 + inpos]>>10) & 2097151) ) + out[2 + outpos - 1];
	...
	out[5 + outpos] = (((in[3 + inpos]>>9) & 2097151) ) + out[5 + outpos - 1];
	...
	out[8 + outpos] = (((in[5 + inpos]>>8) & 2097151) ) + out[8 + outpos - 1];
	...
	out[11 + outpos] = (((in[7 + inpos]>>7) & 2097151) ) + out[11 + outpos - 1];
	...
	out[14 + outpos] = (((in[9 + inpos]>>6) & 2097151) ) + out[14 + outpos - 1];
	...
	out[17 + outpos] = (((in[11 + inpos]>>5) & 2097151) ) + out[17 + outpos - 1];
	...
	out[20 + outpos] = (((in[13 + inpos]>>4) & 2097151) ) + out[20 + outpos - 1];
	...
	out[23 + outpos] = (((in[15 + inpos]>>3) & 2097151) ) + out[23 + outpos - 1];
	...
	out[26 + outpos] = (((in[17 + inpos]>>2) & 2097151) ) + out[26 + outpos - 1];
	...
	out[29 + outpos] = (((in[19 + inpos]>>1) & 2097151) ) + out[29 + outpos - 1];
...
func integratedunpack22(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[3 + outpos] = (((in[2 + inpos]>>2) & 4194303) ) + out[3 + outpos - 1];
	...
	out[6 + outpos] = (((in[4 + inpos]>>4) & 4194303) ) + out[6 + outpos - 1];
	...
	out[9 + outpos] = (((in[6 + inpos]>>6) & 4194303) ) + out[9 + outpos - 1];
	...
	out[12 + outpos] = (((in[8 + inpos]>>8) & 4194303) ) + out[12 + outpos - 1];
	...
	out[16 + outpos] = (((in[11 + inpos]>>0) & 4194303) ) + out[16 + outpos - 1];
	...
	out[19 + outpos] = (((in[13 + inpos]>>2) & 4194303) ) + out[19 + outpos - 1];
	...
	out[22 + outpos] = (((in[15 + inpos]>>4) & 4194303) ) + out[22 + outpos - 1];
	...
	out[25 + outpos] = (((in[17 + inpos]>>6) & 4194303) ) + out[25 + outpos - 1];
	...
	out[28 + outpos] = (((in[19 + inpos]>>8) & 4194303) ) + out[28 + outpos - 1];
...
func integratedunpack23(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[3 + outpos] = (((in[2 + inpos]>>5) & 8388607) ) + out[3 + outpos - 1];
	...
	out[7 + outpos] = (((in[5 + inpos]>>1) & 8388607) ) + out[7 + outpos - 1];
	...
	out[10 + outpos] = (((in[7 + inpos]>>6) & 8388607) ) + out[10 + outpos - 1];
	...
	out[14 + outpos] = (((in[10 + inpos]>>2) & 8388607) ) + out[14 + outpos - 1];
	...
	out[17 + outpos] = (((in[12 + inpos]>>7) & 8388607) ) + out[17 + outpos - 1];
	...
	out[21 + outpos] = (((in[15 + inpos]>>3) & 8388607) ) + out[21 + outpos - 1];
	...
	out[24 + outpos] = (((in[17 + inpos]>>8) & 8388607) ) + out[24 + outpos - 1];
	...
	out[28 + outpos] = (((in[20 + inpos]>>4) & 8388607) ) + out[28 + outpos - 1];
...
func integratedunpack24(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[4 + outpos] = (((in[3 + inpos]>>0) & 16777215) ) + out[4 + outpos - 1];
	...
	out[8 + outpos] = (((in[6 + inpos]>>0) & 16777215) ) + out[8 + outpos - 1];
	...
	out[12 + outpos] = (((in[9 + inpos]>>0) & 16777215) ) + out[12 + outpos - 1];
	...
	out[16 + outpos] = (((in[12 + inpos]>>0) & 16777215) ) + out[16 + outpos - 1];
	...
	out[20 + outpos] = (((in[15 + inpos]>>0) & 16777215) ) + out[20 + outpos - 1];
	...
	out[24 + outpos] = (((in[18 + inpos]>>0) & 16777215) ) + out[24 + outpos - 1];
	...
	out[28 + outpos] = (((in[21 + inpos]>>0) & 16777215) ) + out[28 + outpos - 1];
...
func integratedunpack25(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[4 + outpos] = (((in[3 + inpos]>>4) & 33554431) ) + out[4 + outpos - 1];
	...
	out[9 + outpos] = (((in[7 + inpos]>>1) & 33554431) ) + out[9 + outpos - 1];
	...
	out[13 + outpos] = (((in[10 + inpos]>>5) & 33554431) ) + out[13 + outpos - 1];
	...
	out[18 + outpos] = (((in[14 + inpos]>>2) & 33554431) ) + out[18 + outpos - 1];
	...
	out[22 + outpos] = (((in[17 + inpos]>>6) & 33554431) ) + out[22 + outpos - 1];
	...
	out[27 + outpos] = (((in[21 + inpos]>>3) & 33554431) ) + out[27 + outpos - 1];
...
func integratedunpack26(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[5 + outpos] = (((in[4 + inpos]>>2) & 67108863) ) + out[5 + outpos - 1];
	...
	out[10 + outpos] = (((in[8 + inpos]>>4) & 67108863) ) + out[10 + outpos - 1];
	...
	out[16 + outpos] = (((in[13 + inpos]>>0) & 67108863) ) + out[16 + outpos - 1];
	...
	out[21 + outpos] = (((in[17 + inpos]>>2) & 67108863) ) + out[21 + outpos - 1];
	...
	out[26 + outpos] = (((in[21 + inpos]>>4) & 67108863) ) + out[26 + outpos - 1];
...
func integratedunpack27(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[6 + outpos] = (((in[5 + inpos]>>2) & 134217727) ) + out[6 + outpos - 1];
	...
	out[12 + outpos] = (((in[10 + inpos]>>4) & 134217727) ) + out[12 + outpos - 1];
	...
	out[19 + outpos] = (((in[16 + inpos]>>1) & 134217727) ) + out[19 + outpos - 1];
	...
	out[25 + outpos] = (((in[21 + inpos]>>3) & 134217727) ) + out[25 + outpos - 1];
...
func integratedunpack28(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[8 + outpos] = (((in[7 + inpos]>>0) & 268435455) ) + out[8 + outpos - 1];
	...
	out[16 + outpos] = (((in[14 + inpos]>>0) & 268435455) ) + out[16 + outpos - 1];
	...
	out[24 + outpos] = (((in[21 + inpos]>>0) & 268435455) ) + out[24 + outpos - 1];
...
func integratedunpack29(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[10 + outpos] = (((in[9 + inpos]>>2) & 536870911) ) + out[10 + outpos - 1];
	...
	out[21 + outpos] = (((in[19 + inpos]>>1) & 536870911) ) + out[21 + outpos - 1];
...
func integratedunpack30(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
	...
	out[16 + outpos] = (((in[15 + inpos]>>0) & 1073741823) ) + out[16 + outpos - 1];
...
func integratedunpack31(initoffset uint32, in []uint32, inpos int, out []uint32, outpos int) {
