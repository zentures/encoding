...
func FastUnpack(in []uint32, inpos int, out []uint32, outpos int, bit int) error {
	switch bit {
	case 0:
...
func FastPack(in []uint32, inpos int, out []uint32, outpos int, bit int) error {
	switch bit {
	case 0:
...
func FastPackWithoutMask(in []uint32, inpos int, out []uint32, outpos int, bit int) error {
	switch bit {
	case 0:
...
func fastpackwithoutmask1(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpackwithoutmask2(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 2) |
		((in[2+inpos]) << 4) |
		((in[3+inpos]) << 6) |
...
func fastpackwithoutmask3(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 3) |
		((in[2+inpos]) << 6) |
		((in[3+inpos]) << 9) |
...
func fastpackwithoutmask4(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 4) |
		((in[2+inpos]) << 8) |
		((in[3+inpos]) << 12) |
...
func fastpackwithoutmask5(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 5) |
		((in[2+inpos]) << 10) |
		((in[3+inpos]) << 15) |
...
func fastpackwithoutmask6(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 6) |
		((in[2+inpos]) << 12) |
		((in[3+inpos]) << 18) |
...
func fastpackwithoutmask7(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 7) |
		((in[2+inpos]) << 14) |
		((in[3+inpos]) << 21) |
...
func fastpackwithoutmask8(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 8) |
		((in[2+inpos]) << 16) |
		((in[3+inpos]) << 24)
...
func fastpackwithoutmask9(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 9) |
		((in[2+inpos]) << 18) |
		((in[3+inpos]) << 27)
...
func fastpackwithoutmask10(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 10) |
		((in[2+inpos]) << 20) |
		((in[3+inpos]) << 30)
...
func fastpackwithoutmask11(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 11) |
		((in[2+inpos]) << 22)
...
func fastpackwithoutmask12(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 12) |
		((in[2+inpos]) << 24)
...
func fastpackwithoutmask13(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 13) |
		((in[2+inpos]) << 26)
...
func fastpackwithoutmask14(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 14) |
		((in[2+inpos]) << 28)
...
func fastpackwithoutmask15(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 15) |
		((in[2+inpos]) << 30)
...
func fastpackwithoutmask16(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 16)
...
func fastpackwithoutmask17(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 17)
...
func fastpackwithoutmask18(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 18)
...
func fastpackwithoutmask19(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 19)
...
func fastpackwithoutmask20(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 20)
...
func fastpackwithoutmask21(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 21)
...
func fastpackwithoutmask22(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 22)
...
func fastpackwithoutmask23(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 23)
...
func fastpackwithoutmask24(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 24)
...
func fastpackwithoutmask25(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 25)
...
func fastpackwithoutmask26(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 26)
...
func fastpackwithoutmask27(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 27)
...
func fastpackwithoutmask28(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 28)
...
func fastpackwithoutmask29(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 29)
...
func fastpackwithoutmask30(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 30)
...
func fastpackwithoutmask31(in []uint32, inpos int, out []uint32, outpos int) {
	out[0+outpos] = in[0+inpos] |
		((in[1+inpos]) << 31)
...
func fastpack1(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack2(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack3(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack4(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack5(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack6(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack7(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack8(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack9(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack10(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack11(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack12(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack13(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack14(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack15(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack16(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack17(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack18(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack19(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack20(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack21(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack22(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack23(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack24(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack25(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack26(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack27(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack28(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack29(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack30(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastpack31(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack1(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack2(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack3(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack4(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack5(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack6(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack7(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack8(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack9(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack10(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack11(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack12(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack13(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack14(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack15(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack16(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack17(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack18(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack19(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack20(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack21(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack22(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack23(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack24(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack25(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack26(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack27(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack28(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack29(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack30(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack31(in []uint32, inpos int, out []uint32, outpos int) {
...
func fastunpack32(in []uint32, inpos int, out []uint32, outpos int) {
	copy(out[outpos:outpos + 32], in[inpos:inpos + 32])
}

func fastpack32(in []uint32, inpos int, out []uint32, outpos int) {
	copy(out[outpos:outpos + 32], in[inpos:inpos + 32])
}

func fastpackwithoutmask32(in []uint32, inpos int, out []uint32, outpos int) {
	copy(out[outpos:outpos + 32], in[inpos:inpos + 32])
}

func fastunpack0(in []uint32, inpos int, out []uint32, outpos int) {
	for i := outpos; i < outpos + 32; i++ {
		out[i] = 0
	}
}

func fastpack0(in []uint32, inpos int, out []uint32, outpos int) {
	// nothing
}

func fastpackwithoutmask0(in []uint32, inpos int, out []uint32, outpos int) {
	// nothing
}
